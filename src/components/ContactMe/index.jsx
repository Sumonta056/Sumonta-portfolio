...
const index = () => {
  return (
    <div className="mt-12">
      <div className="max-w-5xl mx-auto bg-[#2e0249] rounded-lg">
        <div className="grid md:grid-cols-2 items-center gap-16 sm:p-10 p-4 font-[sans-serif]">
          <div>
            ...
            <p className="mt-3 text-sm text-gray-400">
              Feel free to reach out and share your experience with my
              portfolio! I'd love to hear your feedback and thoughts on how you
              liked it.
            </p>
            <ul className="mt-6 space-y-8">
              <li className="flex items-center">
                ...
                >
                  <strong>sumontasaha80@gmail.com</strong>
                </a>
              </li>
              <li className="flex items-center">
                <svg
              ...
              <li className="flex items-center">
                ...
                <a
                  ...
                  className="ml-3 text-sm text-white"
                >
                  <strong>Narayanganj, Bangladesh</strong>
                </a>
              </li>
            </ul>
            <ul className="flex mt-12 space-x-4">
              <li className="bg-[#eeeced] hover:bg-[#f1ecf0e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
              ...
              <li className="bg-[#eeeced] hover:bg-[#f1ecf0e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <a href="https://www.instagram.com/_sumonta_saha_/">
                  <FaInstagram color="black" size={25} />
                </a>
              </li>
              <li className="bg-[#eeeced] hover:bg-[#f1ecf0e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <a href="https://www.facebook.com/sumonta.mridul/">
                  <FaFacebook color="black" size={25} />
                </a>
              </li>
              <li className="bg-[#eeeced] hover:bg-[#f1ecf0e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <a href="https://www.youtube.com/@sumontasaha5638">
              ...
              <li className="bg-[#eeeced] hover:bg-[#f1ecf0e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <a href="https://unsplash.com/@sumonta056/stats?stats=all-time">
                  <FaUnsplash color="black" size={25} />
                </a>
              </li>
            </ul>
          </div>
          <div className="p-6 bg-gray-200 rounded-lg">
            <form
              ...
              action="https://formspree.io/f/mknabrlj"
              method="POST"
            >
              <input
                type="name"
